...
import { vertexShader, fragmentShader } from "./shader-hightmap.js"
...
function Terrain() {
    ...
    // PlaneGeometryを生成
    const planeGeometry = useMemo(() => new THREE.PlaneGeometry(20, 20, 1024, 1024), []);
...
function Scene(){
    ...
    return (
        <>
            ...
            <group rotation-x={-80*Math.PI/180}>
                <Terrain />
            </group>
